...
export default class Card {
    ...
    static  popupEditCard = new PopupEditeCard('modal-edite-card')
    static  popupDeleteCard = new PopupDeleteCard('modal-delete-card')
    ...
    init() {
        ...
        this.elemNewCard.btnLike.addEventListener('click', () => { this.handleLikes()});
        this.elemNewCard.btnDislike.addEventListener('click', () => { this.handleDislikes() });
